...
def enrich(evidence_pack_path: Path, scan_canonical_v1_path: Path, out_path: Path, run_id: str):
        ...
        if owner_ok and owner_value:
            if claim_id not in node_ids:
                nodes.append({
                    ...
                    "provenance": {"created_at_utc": observed_at, "method": "derived_from_observation", "source_id": source_id},
    ...
    return {
        ...
        "owner_lookup": {"ok": ok, "fail": fail, "skipped_no_asset": skipped_no_asset},
